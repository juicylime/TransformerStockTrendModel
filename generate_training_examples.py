            ...
            if len(dates_window) == n + 1:
                ...
                if all(len(prices_deque) == n for prices_deque in stocks_window.values()):
                    ...
                    if correlations:
                        ...
                        training_example = {training_example_key: {'X': X, 'Y': Y}}
                ...
                if len(output_data) == chunk_size:
                    ...
                    output_file = os.path.join(output_dir, f"training_examples_chunk_{chunk_count}.json")
...
# Example usage
input_file = 'G:/StockData/combined_stock_data.json'
create_training_examples(input_file)